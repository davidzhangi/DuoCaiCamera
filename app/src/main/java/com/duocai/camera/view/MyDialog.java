...
public class MyDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public MyDialog setCancelable(boolean bool) {
    ...
    public MyDialog setSubmitName(CharSequence name) {
    ...
    public MyDialog setCancelName(CharSequence name) {
        if (!TextUtils.isEmpty(name)) {
            cancel.setText(name);
        }
        return this;
    ...
    public MyDialog setOnClickListener(OnClickButtonListener onClickListener) {
