...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        mParticlePaint.setColor(0x00000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mStatus == STATUS_TEXT_MOVING) {
            ...
            canvas.drawRect(mHostTextX + mHostRectWidth, mHeight / 2 - getTextHeight(mHostText, mHostBgPaint) / 1.2f, mHostTextX + getTextWidth(mHostText, mParticlePaint), mHeight / 2 + getTextHeight(mHostText, mHostBgPaint) / 1.2f, mParticlePaint);
        }
