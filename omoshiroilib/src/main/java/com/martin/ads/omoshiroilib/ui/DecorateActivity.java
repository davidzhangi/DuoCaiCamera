    ...
    private void init() {
        ...
        desFolder =
                mediaType == MimeType.PHOTO ?
                        FileUtils.getFileOnSDCard(GlobalConfig.DUOCAI_PHOTO_PATH).getAbsolutePath() :
                        FileUtils.getFileOnSDCard(GlobalConfig.DUOCAI_VIDEO_PATH).getAbsolutePath();
//                        FileUtils.getLocalGallery(GlobalConfig.LOCAL_GELLERY_PHOTO).getAbsolutePath() :
//                        FileUtils.getLocalGallery(GlobalConfig.LOCAL_GELLERY_VIDEO).getAbsolutePath();
